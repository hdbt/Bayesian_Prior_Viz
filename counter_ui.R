...
counterButton <- function(id, label = "Counter") {
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput(ns("distType"), "Category of distribution",
                  c("Continuous Univariate"="Continuous",
                    "Discrete Univariate"="Discrete",
                    "Multivariate"="Multivariate"),
                  selected="Continuous"),
      conditionalPanel("ns(input.distType)=='Continuous'",
                       selectInput(ns("dist"), "Distribution type:",
                                   c("Beta"="Beta",
                                     "Cauchy"="Cauchy",
      ...
      conditionalPanel("input.distType=='Discrete'",
                       selectInput(ns("dist1"), "Distribution type:",
      ...
      conditionalPanel("input.distType=='Multivariate'",
                       selectInput("dist2", "Distribution type:",
                                   c("Dirichlet"="Dirichlet",
                                     ...
                                     "Wishart"="Wishart"))),
      conditionalPanel(condition="ns(input.distType)=='Continuous'&&ns(input.dist)!='Beta'",
                       sliderInput(ns("n"), "Range", value = 10,min = 0, max = 1000)),
      conditionalPanel(condition="ns(input.distType)=='Continuous'&&ns(input.dist)=='Normal'",
                       sliderInput(ns("normal_mu"), "Mean", min=-30, max=30, value=0, step=0.2),
                       sliderInput(ns("normal_sigma"), "Standard deviation", min=0.1, max=20, value=1, step=0.2)),
